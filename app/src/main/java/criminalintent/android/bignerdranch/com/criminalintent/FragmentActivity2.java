...
public class FragmentActivity2 extends VisibleFragment {

    private String urlContainer = "http://www.shekulli.com.al/api/efundit.php";
    ...
    private class PhotoHolder2 extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public PhotoHolder2(View itemView) {
            ...
            mImage = (ImageView)
                    itemView.findViewById(R.id.home_latest_photo);
            mTitleTextView = (TextView)
                    itemView.findViewById(R.id.title_latest);
            ...
            mDateTextView = (TextView)
                    itemView.findViewById(R.id.date_news);
        ...
        public void bindGalleryItem(category_page item) {
            ...
            mDateTextView.setText(item.getMhour_post());//.substring(16).toString()
    ...
    private class PhotoAdapter extends RecyclerView.Adapter<PhotoHolder2> {
        private List<category_page> mHome_pages;
        public PhotoAdapter(List<category_page> galleryItems) {
            mHome_pages = galleryItems;
        }
        @Override
        public PhotoHolder2 onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            ...
            View view = layoutInflater
                    .inflate(R.layout.news_latest, viewGroup, false);
            return new PhotoHolder2(view);
        }
        @Override
        public void onBindViewHolder(PhotoHolder2 photoHolder, int position) {
    ...
    private class FetchItemsTask extends AsyncTask<Void,Void,List<category_page>> {
        ...
        protected List<category_page> doInBackground(Void... params) { //get data from a website and log it.
            return new criminalintent.android.bignerdranch.com.criminalintent.CategoryFetchr().fetchItems(urlContainer);
    ...
    public void onCreate(Bundle savedInstanceState) { //Fragment.onCreate(Bundle) is a public method whereas Activity.onCreate(Bundle) is protected
        ...
        if (bundle != null) {
            mItemsT = bundle.getParcelableArrayList(EXTRA_FG_ID2);
            Log.i("ggg", "2===================================================: " + String.valueOf(mItemsT.size()));
            mItems = mItemsT;
