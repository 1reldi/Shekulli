...
public class FragmentActivity4 extends VisibleFragment {
    private String urlContainer = "http://www.shekulli.com.al/api/topview.php";
    ...
    private class PhotoAdapter extends RecyclerView.Adapter<PhotoHolder1> {
        private List<category_page> mHome_pages;
        public PhotoAdapter(List<category_page> galleryItems) {
            mHome_pages = galleryItems;
        }
        @Override
        public PhotoHolder1 onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            ...
            return new PhotoHolder1(view);
        }
        @Override
        public void onBindViewHolder(PhotoHolder1 photoHolder, int position) {
    ...
    public void onCreate(Bundle savedInstanceState) { //Fragment.onCreate(Bundle) is a public method whereas Activity.onCreate(Bundle) is protected
        ...
        if (bundle != null) {
            mItemsT = bundle.getParcelableArrayList(EXTRA_FG_ID4);
            Log.i("ggg", "4===================================================: " + String.valueOf(mItemsT.size()));
            mItems = mItemsT;
